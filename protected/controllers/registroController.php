	...
	class registroController extends Controller{
		...
		//Objeto donde almacenamos todas las funciones de PersonsModel.php
			...
			$this->_sidebar_menu =array(
				...
				'link' => BASE_URL . 'registro/persona'
						),array(
				'id' => 'list',
				'title' => 'Listar Personas',
				'link' => BASE_URL . 'registro/listadopersona'
						),array(
				'id' => 'general',
				'title' => 'Registros Generales',
				'link' => BASE_URL . 'registro/general'
						)
									);//fin sidebar
		}
		
		function index(){
			$this->_view->render('persona', 'registro', '',$this->_sidebar_menu);
		...
		function general(){
			$this->_view->render('general', 'registro', '',$this->_sidebar_menu);
			// clase  metodo 	  vista    carpeta dentro de views 
		}

		function listadopersona(){
			$this->_view->render('listapersonas', 'registro', '',$this->_sidebar_menu);
			// clase  metodo 	  vista    carpeta dentro de views 
		}


		function generales(){
			$this->_view->render('generales', 'registro', '',$this->_sidebar_menu);
			// clase  metodo 	  vista    carpeta dentro de views 
		}
